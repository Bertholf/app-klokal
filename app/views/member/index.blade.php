						...
						<li class="list-group-item">
							<div class="media">
								<a class="pull-left" href="/user/{{$uw_gain->twitter_handle}}">
									<img class="media-object img-circle img-responsive" src="{{$uw_gain->image}}" height='48' width='48' alt="...">
								</a>
								<div class="media-body">
									<h3 class="media-heading">
						...
						<li class="list-group-item">
							<div class="media">
								<a class="pull-left" href="/user/{{$uw_loss->twitter_handle}}"">
									<img class="media-object img-circle img-responsive" height='48' width='48' src="{{$uw_loss->image}}" alt="...">
								</a>
								<div class="media-body">
									<h3 class="media-heading">
										<span class='user-name'>
