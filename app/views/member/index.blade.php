...
<div id="top-user-container">
	...
	<div class='container top-users'>
		<div class='lead'><h2>Hawaii's Top 10 Klout Scores</h2></div><!--/.lead-->
...
<div class="container">
	<div class='well'>
		<div class='row'>
			<div class='col-sm-6'>
				<div class='lead'>
					<h2><a href='/lists'>Hawaii's Popular Lists </a><small style='margin-left:20px;'>Updated daily.</small></h2>
				</div><!--/.lead-->
			</div><!--/.col-sm-6-->
			<div class='col-sm-6'>
		...
		@foreach ($lists as $list)
			<div class='col-sm-3'>
				<ul class="list-group klout-list">
					...
					{{-- Commenting this out with blade templating.
						TODO:: Move this into controller and insert variable into the href attribute within view
						<li class="list-group-item last">
