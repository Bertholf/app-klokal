      ...
      <div id='content-wrapper' class='row'>
        <div class='col-xs-12'>
          ...
          <div class='row'>
            <div class='col-md-6'>
                <div class='well'>
                  <form role="form" class='validate-form' method='post' action='/admin/location-add' name='location'>
                    <div class='row'>
                    ...
                    <div class='row'> 
                      <div class="form-group col-sm-12">
                        ...
                        <input type="text" class="form-control" id="latitude" name='latitude' required="required" placeholder="30.267153">
                      </div>
                    </div><!--/.row-->
                    <div class='row'> 
                      <div class="form-group col-sm-12">
                        <label for="description">Longitude</label>
                        <input type="text" class="form-control" id="longitude" name='longitude' required="required" placeholder="-97.7430608">
                      </div>
                    </div><!--/.row-->
                    <div class='row'>
                      <div class="form-group col-sm-12">
                        ...
                        <input type="text" class="form-control" id="Radius" name='radius' required="required" placeholder="20 KM">
                      </div>
                    </div><!--/.row-->
                    <div class='row'>
                      <div class="form-group col-sm-12">
                        ...
                        <input type="file" id="exampleInputFile" class='btn-primary' title='Upload an Image' name='image'>
                    ...
                    <div class='row'>
                      <div class='form-group col-sm-8'>
                        ...
                        <select class="form-control" id='scan-mode' name='scan-mode'>
                          <option value ='1'>Yes, Scan New</option>
                          <option value='0'>No, Just Update</option>
                        </select>
                        <hr class='normal'>
                      </div><!--/.form-group-->
                    </div><!--/.row-->
                    <div class='row'>
                      <div class='col-lg-12'>
                        <button type="reset" class="btn btn-lg btn-default"><i class='icon-arrow-left'> </i> Go Back</button>
